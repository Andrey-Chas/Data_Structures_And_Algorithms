    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    Console.Write("This option does not exist. Please type an existing one: ");
                ...
                if (userInput == "7")
                {
                    ...
                    {
                        Console.Clear();
                        DisplayListOfStudentsOrdered(data);
                    }
                    else
                    {
                        Console.Clear();
        ...
        private static void DisplayCoverPage()
        {
            ...
            Console.WriteLine("\n\t7. Display list of students ordered by first name");
            Console.WriteLine("\n\t8. Display student with the best score");
            Console.WriteLine("\n\t9. Display student with the lowest score");
            Console.WriteLine("\n\t0. Exit");
            Console.Write("\nPlease enter your choice by typing one number (0 - 9): ");
        }
        ...
        private static void AddStudent(CustomDataList data)
        {
            ...
            var averageScore = Console.ReadLine();
            while (!float.TryParse(averageScore, out num) || Convert.ToDouble(averageScore) < 3 || Convert.ToDouble(averageScore) > 6)
            {
                Console.Write("This is not a number or it is outside the range.\nPlease type a number (3 - 6, decimal format with comma): ");
                averageScore = Console.ReadLine();
            }

            var averageScoreConverted = Convert.ToDouble(averageScore);
            ...
            Student student = new Student
            {
                ...
                AverageScore = (float)averageScoreConverted
            };
        ...
        private static void DisplayListOfStudentsOrdered(CustomDataList data)
        {
            Console.WriteLine("THE LIST OF STUDENTS ORDERED BY FIRST NAME");
            Console.WriteLine();
        ...
        private static void StudentWithBestScore(CustomDataList data)
        {
            Console.WriteLine("STUDENT WITH BEST SCORE");
            Console.WriteLine();
        ...
        private static void StudentWithLowestScore(CustomDataList data)
        {
            Console.WriteLine("STUDENT WITH LOWEST SCORE");
            Console.WriteLine();
